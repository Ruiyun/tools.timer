{:namespaces
 ({:source-url nil,
   :wiki-url "ruiyun.tools.timer-api.html",
   :name "ruiyun.tools.timer",
   :author "ruiyun",
   :doc
 ...
 ({:arglists ([timer]),
   :name "cancel!",
   :namespace "ruiyun.tools.timer",
   :source-url nil,
   :added "1.0.0",
   :raw-source-url nil,
   :wiki-url "/ruiyun.tools.timer-api.html#ruiyun.tools.timer/cancel!",
   :doc
   "Terminates a timer, discarding any currently scheduled tasks.",
   :var-type "function",
   :line 78,
   :file "src/ruiyun/tools/timer.clj"}
  {:arglists ([] [name]),
   :name "deamon-timer",
   :namespace "ruiyun.tools.timer",
   :source-url nil,
   ...
   :raw-source-url nil,
   :wiki-url
   "/ruiyun.tools.timer-api.html#ruiyun.tools.timer/deamon-timer",
  ...
  {:arglists ([task & {:keys [by at delay period on-exception]}]),
   ...
   :raw-source-url nil,
   :wiki-url
   "/ruiyun.tools.timer-api.html#ruiyun.tools.timer/run-task!",
   :doc
  ...
  {:arglists ([] [name]),
   ...
   :added "1.0.0",
   :raw-source-url nil,
   :wiki-url "/ruiyun.tools.timer-api.html#ruiyun.tools.timer/timer",
